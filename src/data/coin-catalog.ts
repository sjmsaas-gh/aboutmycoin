 ...
 * ---------------------------------------------------------------------------
 *
 * Nine entries, chosen to exercise every branch of the structure rather than
 * to be a catalogue: five groups, six denominations, three countries, both
 ...
 *
 * None carries `values`. Graded prices wait on the market-data decision in
