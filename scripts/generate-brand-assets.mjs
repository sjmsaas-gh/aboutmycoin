 ...
 *
 * RENAME: the two headline lines are the only copy here.
 */
const ogCard = `
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <rect width="1200" height="630" fill="${BG}"/>
  <rect x="0" y="0" width="1200" height="10" fill="${ACCENT}"/>
  <text x="72" y="118" font-family="${FONT}" font-size="34" font-weight="700" fill="${INK}">${SITE.name}</text>
  ...
  <text x="72" y="440" font-family="${FONT}" font-size="24" fill="${MUTED}">${SITE.tagline}.</text>
...
const og = await sharp(Buffer.from(ogCard))
  .composite([{ input: await coin(300), left: 845, top: 165 }])
  .png(PNG)
  .toBuffer();
